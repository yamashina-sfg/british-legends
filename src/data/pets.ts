...
export const PETS: Record<string, PetDefinition> = {
  star_fox: { id:'star_fox', name:'星詠みの白狐', sourceEnemyId:'ghost', rank:3, element:'light', baseStats:{hp:55,mp:30,atk:12,int:20,def:10,mdef:18,spd:19,luk:8}, growth:{hp:5,mp:3,atk:2,int:4,def:2,mdef:3,spd:2,luk:1}, skillIds:['curse_word','story_barrier'], enhanceMaterialId:'ghost_fragment', expScale:2 },
