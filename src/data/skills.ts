...
export const SKILLS: Record<string, Skill> = {
  ...
  arcane_burst: { id:'arcane_burst',name:'写本爆発',type:'attack',target:'all',mpCost:10,power:1,damageKind:'magic',element:'light',explosion:true,targetBookItemId:'witch_scroll',itemMultiBase:1.5,itemMultiAdd:0.01,description:'指定した物語座標を中心に、回避不能の魔法爆発を起こす。予言の写本で威力上昇。' },
