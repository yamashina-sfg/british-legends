...
export const EQUIPMENT: Record<string, Equipment> = {
  ...
  steel_sword: { id: 'steel_sword', name: '鋼の剣', slot: 'weapon', price: 72, requiredLevel: 8, bonus: { atk: 10 }, worldId: 'beowulf', description: '怪物の牙にも負けない、重い鋼の剣。' },
  runic_blade: { id: 'runic_blade', name: 'ルーンの刃', slot: 'weapon', price: 108, requiredLevel: 15, bonus: { atk: 14, mp: 4 }, worldId: 'beowulf', description: '古英語の刻印が、技の力を引き出す。' },
  hero_sword: { id: 'hero_sword', name: '英雄の剣', slot: 'weapon', price: 148, requiredLevel: 24, bonus: { atk: 18, spd: 2 }, worldId: 'beowulf', description: '失われた物語を修復する者に応える剣。' },
  geat_greatsword: { id: 'geat_greatsword', name: 'ゲアト族の大剣', slot: 'weapon', price: 220, requiredLevel: 35, bonus: { atk: 25, def: 2 }, worldId: 'beowulf', description: '竜の巣へ挑むための、両手持ちの大剣。' },
  ...
  iron_armor: { id: 'iron_armor', name: '鉄鎧', slot: 'armor', price: 62, requiredLevel: 8, bonus: { def: 8 }, worldId: 'beowulf', description: '鈍い鉄の光を放つ、堅い胸当て。' },
  scale_mail: { id: 'scale_mail', name: '鱗の胸当て', slot: 'armor', price: 94, requiredLevel: 15, bonus: { hp: 12, def: 10 }, worldId: 'beowulf', description: '水棲の怪物の鱗を重ねた胸当て。' },
  hero_armor: { id: 'hero_armor', name: '英雄鎧', slot: 'armor', price: 132, requiredLevel: 24, bonus: { hp: 24, def: 13 }, worldId: 'beowulf', description: '英雄の誓いを宿す、古い鎧。' },
  rune_plate: { id: 'rune_plate', name: 'ルーンの鎧', slot: 'armor', price: 190, requiredLevel: 35, bonus: { hp: 30, mp: 5, def: 16 }, worldId: 'beowulf', description: '言葉そのものを刻んだ、重厚な胸甲。' },
